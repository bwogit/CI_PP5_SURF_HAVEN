...
class Order(models.Model):
    ...
    address1 = models.CharField(max_length=80, null=False, blank=False, default='')
...
class OrderLineItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        """
        Ovveride the default save method to establish the line item total and refresh the order total.
        """
